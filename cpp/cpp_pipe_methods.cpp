...
// void cpp_to_python_win32pipe::data_import_manager::threaded_data_import(){
//     HANDLE hPipe;
...
// Flip bool
// Base From: https://stackoverflow.com/questions/26561604/create-windows-named-pipe-in-c
// void cpp_to_python_win32pipe::data_export_manager::data_export(std::string id, int size, unsigned char* data){
//     HANDLE hPipe;
//     DWORD dwWritten;
...
//                        0,                                       // Default Attributes
//                        NULL);
//     std::string cpp_message = "Hello Pipe from C++!";

//     if (hPipe != INVALID_HANDLE_VALUE)
//     {
//         WriteFile(hPipe,
//                   cpp_message.c_str(),   // Message
//                   cpp_message.length(),               // = length of string + terminating '\0' !!!
//                   &dwWritten,       // Written Bytes
//                   NULL);            // Not Overlapped
