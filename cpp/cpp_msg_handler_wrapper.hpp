...
namespace cpp_to_python_win32pipe{
    class cpp_msg_handler_wrapper{
        ...
        public:
            // Starts up it's own connection
            cpp_msg_handler_wrapper();
            // Constructor, takes in a connection to sort
            cpp_msg_handler_wrapper(cpp_to_python_win32pipe::cpp_to_python* msg_rec);
            // Destructor
            ~cpp_msg_handler_wrapper();
            ...
            // Wrapper Functions for unmodifed elements of cpp_to_python (View cpp_pipehandler.hpp for documentation)
