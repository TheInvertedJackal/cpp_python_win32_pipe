...
exporter.export_data("hello_from_python", b"Hello my sweet C++, I love you so much!!! You make my day bringer! You're so much better and faster than I am! I wish I was like you!")
while True:
    one = 1